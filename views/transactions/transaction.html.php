                ...
                <div class="container shadow p-1 mt-3 mb-3  rounded">
                    ...
                    <form method="get">
                        <div class="d-flex align-items-center p-2">
                            ...
                            <button type="submit" class="btn btn-primary mx-3" name="action" value="filter"
                                id="btnFilter">Ok</button>
                ...
                <div class="container shadow p-3  mb-3  rounded">
                    ...
                    <form action="" method="post">
                        <div class=" d-flex flex-column align-items-center justify-content-around">
                            ...
                            <button type="submit" class="btn btn-primary mt-2 col-4" name="action"
                                value="addTransaction" id="btnSave">Enregistrer</button>
